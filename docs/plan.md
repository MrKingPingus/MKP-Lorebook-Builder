...
**Mockup:** `mockup-ui-overhaul.html` covered 13A and 13C in five walkable states — dark-theme only and throwaway by design, and deleted once Phase 14 landed along with Phase 14's own two. It is in git history if the states are ever wanted; the decisions it drove are recorded below rather than in it. 13B was deliberately not mocked; an accordion with different contents is better reviewed as a written outline than as pixels.
