...
![The lorebook title menu open, showing saved lorebooks beside import and export controls](../public/screenshots/0.9.0/01-title-menu.png)
...
![The import flow showing four choices: import as new, append, replace, and back up first](../public/screenshots/0.9.0/02-import.png)
...
![The Settings panel showing four collapsed sections and a filter box](../public/screenshots/0.9.0/05-settings.png)
...
![The status bar across the bottom of the window](../public/screenshots/0.9.0/03-status-bar.png)
...
![The Size menu open, with the window-size options flown out](../public/screenshots/0.9.0/04-size-menu.png)
...
![The pull tab opened, with the lorebook list beside the entry list and the window widened to fit](../public/screenshots/0.9.0/06-pull-tab.png)
