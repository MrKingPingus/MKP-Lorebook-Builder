...
export const SETTINGS_GROUP_KEYWORDS = {
  ...
  warningScale:     'warning color colour scale three four gradient orange green yellow red counters bands steps fade',
  counterThresholds:'character count thresholds limit yellow orange red numbers chars',
